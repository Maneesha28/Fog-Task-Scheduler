...
public class Task implements Comparable<Task> {
    ...
    public String toString() {
        return "Task{" +
                "taskID=" + taskID +
                ", originalPriorityLevel=" + originalPriorityLevel +
                ", numOfParents=" + parentTasks.size() +
                ", imposedPriorityLevel=" + imposedPriorityLevel +
                ", vmID=" + vmID +
    ...
    public int compareTo(Task o) {
        if (this.numMI == o.numMI) {
            if (this.deadline == o.deadline) {
                return Integer.compare(this.originalPriorityLevel, o.originalPriorityLevel);
            } else {
                return Double.compare(this.deadline, o.deadline);
            }
        } else {
            return Integer.compare(this.numMI, o.numMI);
        }
    }
}
