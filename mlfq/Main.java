...
//                System.out.println(fileName + " " + parts[2]);
    ...
    public static void writeToFile(List<Task> tasks, int itr){
        ...
        String outputFilename = outputDir + "\\MLFQ\\result_" + itr + ".csv";
        try {
            ...
            csvWriter.flush();
            csvWriter.close();
            System.out.println("Results written to MLFQ_results.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
